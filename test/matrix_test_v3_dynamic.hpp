...
namespace dynamic_matrix_test {
    ...
    auto testIntAssign() ->void {
        DMatrix<size_t> m(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        DMatrix<size_t> n(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
    ...
    auto testIntAdd() ->void {
        DMatrix<size_t> m(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        DMatrix<size_t> n(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        DMatrix<size_t> sum(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
    ...
    auto testIntSub() ->void {
        DMatrix<size_t> m(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        DMatrix<size_t> n(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        DMatrix<size_t> test(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
    ...
    auto testIntSubAssign() ->void {
        DMatrix<size_t> m(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        DMatrix<size_t> n(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        DMatrix<size_t> diff(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
    ...
    auto testComplexAssign() ->void {
        DMatrix<complex<size_t>> m(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        DMatrix<complex<size_t>> n(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        for(auto i = 0; i < m.rows(); i++){
            for(auto j = 0; j < m.cols(); j++){
    ...
    auto testComplexAdd() ->void {
        DMatrix<complex<size_t>> m(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        DMatrix<complex<size_t>> n(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        DMatrix<complex<size_t>> sum(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
    ...
    auto testComplexSub() ->void {
        DMatrix<complex<size_t>> m(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        DMatrix<complex<size_t>> n(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        DMatrix<complex<size_t>> test(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        for(auto i = 0; i < m.rows(); i++){
            for(auto j = 0; j < m.cols(); j++){
                m.set_element(complex(i + j,i + j),i,j);;
            }
    ...
    auto testComplexSubAssign() ->void {
        DMatrix<complex<size_t>> m(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        DMatrix<complex<size_t>> n(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        DMatrix<complex<size_t>> diff(MATRIX_TEST_SIZE, MATRIX_TEST_SIZE);
        for(auto i = 0; i < m.rows(); i++){
            for(auto j = 0; j < m.cols(); j++){
                m.set_element(complex(i + j,i + j),i,j);;
            }
